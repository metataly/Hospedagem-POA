    ...
    <div id="page1" class="page active">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="max-w-6xl mx-auto">
                <!-- FORMULÁRIO ADICIONADO (MANTIDO O DESIGN EXISTENTE) -->
                <form id="quartoForm" action="selecionarQuarto" method="POST">
                    <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                        <h2 class="text-2xl font-semibold text-gray-800 mb-4">Filtros de Busca</h2>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Hóspedes</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="room-card bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center mb-4">
                                    <!-- ALTERADO: type="radio" e name="quarto" adicionado -->
                                    <input type="radio" id="room1" name="quarto" value="Standard" class="room-radio mr-2" data-price="150" required>
                        ...
                        <div class="room-card bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center mb-4">
                                    <!-- ALTERADO: type="radio" e name="quarto" adicionado -->
                                    <input type="radio" id="room2" name="quarto" value="Deluxe" class="room-radio mr-2" data-price="250" required>
                        ...
                        <div class="room-card bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center mb-4">
                                    <!-- ALTERADO: type="radio" e name="quarto" adicionado -->
                                    <input type="radio" id="room3" name="quarto" value="Premium" class="room-radio mr-2" data-price="450" required>
                    ...
                    <div class="text-center mt-8">
                        <!-- ALTERADO: type="submit" em vez de button regular -->
                        <button type="submit"
